...
caf::SRInteractionTruthDLP fill_truth_interaction(dlp::types::TruthInteraction &in, std::vector<dlp::types::TruthParticle> &particles)
{
  ...
  for(dlp::types::TruthParticle &p : particles)
  {
