...
namespace dlp::types
{
    ...
    */
    ...
    H5::CompType BuildCompType<TruthParticle>()
    {
        ...
        ctype.insertMember("module_ids", HOFFSET(TruthParticle, module_ids_handle), H5::VarLenType(H5::PredType::IEEE_F32LE));
        ...
        ctype.insertMember("truth_end_dir", HOFFSET(TruthParticle, truth_end_dir), H5::ArrayType(H5::PredType::IEEE_F64LE,  1, &std::array<hsize_t, 1>{3}[0]));
